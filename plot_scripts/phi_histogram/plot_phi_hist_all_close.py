...
if __name__ == "__main__":
    ...
    with pyhepmc.open(fname) as f:
        ...
        ax.hist(particles['phi'],log=True,bins=100)
        ax.set_xlabel("phi")
        ax.set_ylabel("counts")
        ax.set_title(f"phi histogram")
        ax.set_ylim((1e5,2e5))
        ...
        print(f"Saving figure: ../../figures/kinematics/{outFolder}/all/phi_histogram_close.png")
        plt.savefig(f"../../figures/kinematics/{outFolder}/all/phi_histogram_close.png")
