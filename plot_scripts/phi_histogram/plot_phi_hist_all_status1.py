...
if __name__ == "__main__":
    ...
    with pyhepmc.open(fname) as f:
        ...
        ax.hist(particles['phi'],log=True,bins=20)
        ax.set_xlabel("phi")
        ax.set_ylabel("counts")
        ax.set_title(f"phi histogram status 1")
        ax.set_ylim((1e3,1e6))
        ...
        print(f"Saving figure: ../../figures/kinematics/{outFolder}/all/phi_histogram_status1.png")
        plt.savefig(f"../../figures/kinematics/{outFolder}/all/phi_histogram_status1.png")
