...
if __name__ == "__main__":
    ...
    for i in range(len(fileList)):
        ...
        try:
            ...
            with pyhepmc.open(fname) as f:
                ...
                hist, bins = np.histogram(particles['energy'], bins=50)
    ...
    ax.set_title(f"all particles")
            

    ax.legend()
           
          
    outFolder = f"/local/d1/mmantinan/darkQCD_pythia_simulations/figures/kinematics/energy"
