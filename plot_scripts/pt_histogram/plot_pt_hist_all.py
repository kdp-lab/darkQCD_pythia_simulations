...
if __name__ == "__main__":
    ...
    with pyhepmc.open(fname) as f:
        ...
        ax.hist(particles['pt'],log=True,bins=100)
        ax.set_xlabel("pt [GeV]")
        ax.set_ylabel("counts")
        ax.set_title(f"pt histogram")
        ...
        print(f"Saving figure: ../../figures/kinematics/{outFolder}/all/pt_histogram.png")
        plt.savefig(f"../../figures/kinematics/{outFolder}/all/pt_histogram.png")
