...
if __name__ == "__main__":
    ...
    with pyhepmc.open(fname) as f:
        ...
        ax.hist(particles['pt'],log=True,bins=50)
        ax.set_xlabel("pt[GeV]")
        ax.set_ylabel("counts")
        ax.set_title(f"pt histogram dark particles")
        ...
        print(f"Saving figure: ../../figures/kinematics/{outFolder}/dark/pt_histogram.png")
        plt.savefig(f"../../figures/kinematics/{outFolder}/dark/pt_histogram.png")
