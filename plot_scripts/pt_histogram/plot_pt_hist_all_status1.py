...
if __name__ == "__main__":
    ...
    with pyhepmc.open(fname) as f:
        ...
        ax.hist(particles['pt'],log=True,bins=20)
        ax.set_xlabel("pt[GeV]")
        ax.set_ylabel("counts")
        ax.set_title(f"pt histogram status 1")
        ...
        print(f"Saving figure: ../../figures/kinematics/{outFolder}/all/pt_histogram_status1.png")
        plt.savefig(f"../../figures/kinematics/{outFolder}/all/pt_histogram_status1.png")
