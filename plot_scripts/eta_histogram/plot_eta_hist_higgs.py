...
if __name__ == "__main__":
    ...
    with pyhepmc.open(fname) as f:
        ...
        particles = particles[particles["id"]==25]
        ...
        ax.set_title(f"eta histogram higgs particles")
        ...
        if not os.path.exists(f"../../figures/kinematics/{outFolder}/higgs/"):
            print(f"Creating directory ../../figures/kinematics/{outFolder}/higgs/")
            os.makedirs(f"../../figures/kinematics/{outFolder}/higgs/")


        print(f"Saving figure: ../../figures/kinematics/{outFolder}/higgs/eta_histogram.png")
        plt.savefig(f"../../figures/kinematics/{outFolder}/higgs/eta_histogram.png")
