...
if __name__ == "__main__":
    ...
    with pyhepmc.open(fname) as f:
        ...
        print(f"Saving figure: ../../figures/kinematics/{outFolder}/all/eta_histogram_status1.png")
        plt.savefig(f"../../figures/kinematics/{outFolder}/all/eta_histogram_status1.png")
